/**
 * Add future projects here — the site updates automatically.
 * Each project needs: title, summary, tags, year, and at least one link.
 */
window.PROJECTS = [
  {
  ...
  },
  {
    ...
    tags: ["Public Health", "Cancer Screening", "AIHW", "NSW", "Primary Care"],
    year: "2025",
    featured: false,
    links: [
      { label: "Read report", url: "https://anchita88-sys.github.io/nsw-phn-preventive-health/project3.html", external: true },
      { label: "Main project", url: "https://anchita88-sys.github.io/nsw-phn-preventive-health/", external: true },
      { label: "GitHub", url: "https://github.com/anchita88-sys/nsw-phn-preventive-health", external: true },
    ],
  },
  {
    title: "Preventive Healthcare Access Across NSW PHNs",
    summary:
